...
const stateContacts = {
    items:['+7 925 026 44 22', '+7 925 026 69 44', 'info@girobay.com', '125284, Россия, г. Москва, ул. Поликарпова, д. 27', 'Пн - Пт: 10.00 - 20.00 Сб - Вс: 11.00 - 20.00', 'ОГРНИП: 000000000000000'],
    link: 'Контакты',
    input: false
}
